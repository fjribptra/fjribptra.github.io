      ...
      <div className="max-w-3xl mx-auto mt-16 flex flex-col gap-5 p-3">
        <div className="flex justify-start items-center gap-5">
          ...
          <div className="flex flex-col gap-3">
            ...
            <h2 className="bg-blue-200 w-fit">Fullstack Web Developer</h2>
          </div>
        </div>
        <div>
        ...
        <SocialIcons/>
          <div className="">
            ...
            <div className="container bg-slate-100 mx-auto flex flex-col gap-7 justify-center items-center p-0 md:p-3 md:grid md:grid-cols-2 lg:grid-cols-2">
              <ProjectListCards/>
            </div>
          </div>
      </div>
